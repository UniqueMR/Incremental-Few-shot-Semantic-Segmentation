...
class Dataset(object):
    def __init__(self, data_dir, fold, input_size=[321, 321], normalize_mean=[0, 0, 0],
        ...
        for index in range (1000):
            ...
            support_names = []
            while len(support_names) < self.shots:  # random sample a support data
                support_name = support_img_list[random.randint(0, len(support_img_list) - 1)]
                if support_name != query_name and support_name not in support_names:
    ...
    def get_new_exist_class_dict(self, fold):
        ...
        for fold in fold_list:
            ...
            while True:
                ...
                cat_list.append(cat)
        print('eval categories available: ', set(cat_list))
    ...
    def __getitem__(self, index):
        ...
        query_name, sample_class, support_names = self.query_class_support_list[index]
